...
<body class="" style="background-color: #30caa0;">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <a href="#" id="validate" onclick="submitLoginAjax();" style="background-color: #30caa0;color:white;" class="btn btn-user btn-block">
                                            Se connecter
                                        </a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" style="color:black;" href="forgot-password.html">Mot de passe oublié ?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        ...
                        if (val[0] == "true") {
                            ...
                            setTimeout(() => {
                                location.href = '/admin/manageAnnonces';
                            }, 600);
